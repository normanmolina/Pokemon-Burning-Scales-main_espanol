...
=end
  ...
  # mode, as well as the color of the text, to mimic the one used in BW
      textpos.push([_INTL("Resultados de la búsqueda"),126,48,2,base,shadow])
  ...
  # text, to mimic the one used in BW
      textpos.push([_INTL("VISTO"),126,48,0,base,shadow])
      textpos.push([$Trainer.pokedex.seen_count(pbGetPokedexRegion).to_s,242,48,1,base,shadow])
      textpos.push([_INTL("DUEÑO"),334,48,0,base,shadow])
  ...
  def pbRefreshDexSearch(params,_index)
    ...
    textpos = [
       [_INTL("Modo de búsqueda"),Graphics.width/5,4,2,base,shadow],
       [_INTL("Orden"),136,52,2,base,shadow],
       [_INTL("Nombre"),58,110,2,base,shadow],
       [_INTL("Tipo"),58,162,2,base,shadow],
       [_INTL("Altura"),58,214,2,base,shadow],
       [_INTL("Peso"),58,266,2,base,shadow],
       [_INTL("Color"),326,110,2,base,shadow],
       [_INTL("Forma"),454,162,2,base,shadow],
       [_INTL("Resetear"),80,338,2,base,shadow,1],
       [_INTL("Iniciar"),Graphics.width/2,338,2,base,shadow,1],
       [_INTL("Cancelar"),Graphics.width-80,338,2,base,shadow,1]
    ]
