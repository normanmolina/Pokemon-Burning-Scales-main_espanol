...
:Land => "Hierva",
:LandDay => "Hierva (día)",
:LandNight => "Hierva (noche)",
:LandMorning => "Hierva (mañana)",
:LandAfternoon => "Hierva (tarde)", 
:LandEvening => "Hierva (noche)",
:Cave => "Cueva",
:CaveDay => "Cueva (día)",
:CaveNight => "Cueva (noche)",
:CaveMorning => "Cueva (mañana)",
:CaveAfternoon => "Cueva (tarde)",
:CaveEvening => "Cueva (noche)",
:Water => "Surfeando",
:WaterDay => "Surfeando (día)",
:WaterNight => "Surfeando (noche)",
:WaterMorning => "Surfeando (mañana)",
:WaterAfternoon => "Surfeando (tarde)",
:WaterEvening => "Surfeando (noche)",
:OldRod => "Pescando (Old Rod)",
:GoodRod => "Pescando (Good Rod)",
:SuperRod => "Pescando (Super Rod)",
:RockSmash => "Aplasta Roca",
:HeadbuttLow => "Cabezazo (raro)",
:HeadbuttHigh => "Cabezazo (común)",
:BugContest => "Concurso de Insectos"
}
